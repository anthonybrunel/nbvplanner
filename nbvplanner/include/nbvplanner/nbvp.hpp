      ...
      nh_private_(nh_private)
{
    ...
    octomap_sub_ = (nh_.subscribe("octomap_full", 1, &nbvInspection::nbvPlanner<stateVec>::octomapCallback, this));
...
template<typename stateVec>
void nbvInspection::nbvPlanner<stateVec>::octomapCallback(const octomap_msgs::Octomap &msg)
{
