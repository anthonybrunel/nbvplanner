...
public:
    ...
    virtual void iterate(int iterations,std::shared_ptr<octomap::OcTree> &ot_) = 0;
    virtual void initialize(std::shared_ptr<octomap::OcTree> &ot_) = 0;
